...
{/if}
  ...
  Voici la liste des élèves ajoutés à l'application. Vous pourrez aller à la page de réinitialisation des mots de passe pour leur attribuer un mot de passe.
<br>
<div class="formdata">
  <table>
    <thead>
