...
<div class="container">
    <form name='confirmform' action='index.php' method='post'>
        ...
        <div class="formbuttons">
            ...
            <img src='images/yes_24.png' width='24' height='24' title='Confirmer' {$confirm_link} />Confirmer
            <img src='images/no_24.png' width='24' height='24' title='Annuler' {$cancel_link} />Annuler
        </div>
    </form>
</div>
